...
- `docs/china-expos.ics`：全国展会
- `docs/china-live-music.ics`：全国演唱会和音乐节

用于 Apple/Google/Outlook 的日历订阅。
...
4. 等待 Pages 生效，得到地址：
   ...
   - `https://<你的GitHub用户名>.github.io/expo-calendar-subscription/china-live-music.ics`
